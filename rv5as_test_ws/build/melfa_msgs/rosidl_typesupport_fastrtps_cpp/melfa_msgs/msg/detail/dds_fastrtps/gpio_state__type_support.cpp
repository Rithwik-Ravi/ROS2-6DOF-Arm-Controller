...
#include "melfa_msgs/msg/detail/gpio_state__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.interface_name;
  // Member: bitid
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = melfa_msgs::msg::GpioState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const melfa_msgs::msg::GpioState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<melfa_msgs::msg::GpioState *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GpioState__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const melfa_msgs::msg::GpioState *>(
...
static size_t _GpioState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GpioState(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GpioState__callbacks = {
  "melfa_msgs::msg",
  "GpioState",
...
static rosidl_message_type_support_t _GpioState__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GpioState__callbacks,
...
{
  return &melfa_msgs::msg::typesupport_fastrtps_cpp::_GpioState__handle;
}
