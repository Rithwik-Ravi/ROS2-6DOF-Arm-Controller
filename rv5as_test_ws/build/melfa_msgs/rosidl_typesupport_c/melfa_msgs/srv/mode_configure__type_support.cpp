...
static const _ModeConfigure_Request_type_support_symbol_names_t _ModeConfigure_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, melfa_msgs, srv, ModeConfigure_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, melfa_msgs, srv, ModeConfigure_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, melfa_msgs, srv, ModeConfigure_Request)() {
  return &::melfa_msgs::srv::rosidl_typesupport_c::ModeConfigure_Request_message_type_support_handle;
}
...
static const _ModeConfigure_Response_type_support_symbol_names_t _ModeConfigure_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, melfa_msgs, srv, ModeConfigure_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, melfa_msgs, srv, ModeConfigure_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, melfa_msgs, srv, ModeConfigure_Response)() {
  return &::melfa_msgs::srv::rosidl_typesupport_c::ModeConfigure_Response_message_type_support_handle;
}
...
static const _ModeConfigure_type_support_symbol_names_t _ModeConfigure_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, melfa_msgs, srv, ModeConfigure)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, melfa_msgs, srv, ModeConfigure)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, melfa_msgs, srv, ModeConfigure)() {
  return &::melfa_msgs::srv::rosidl_typesupport_c::ModeConfigure_service_type_support_handle;
}
